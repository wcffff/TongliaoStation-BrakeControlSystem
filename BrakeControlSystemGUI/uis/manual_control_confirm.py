...
# Form implementation generated from reading ui file 'manual_control_confirm.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "手动控制"))
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:16pt; font-weight:600;\">确定要修改为场控模式？</span></p></body></html>"))
